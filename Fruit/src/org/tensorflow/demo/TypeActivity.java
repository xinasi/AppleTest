...
public class TypeActivity extends CameraActivity implements ImageReader.OnImageAvailableListener {
    ...
    private static final String MODEL_FILE = "file:///android_asset/ty_optimized_graph.pb";
    private static final String LABEL_FILE =
            "file:///android_asset/ty_retrained_labels.txt";
        ...
        builder.setItems(items, new DialogInterface.OnClickListener(){
            ...
            public void onClick(DialogInterface dialog,int which){
                ...
                if (items[which] == "蘋果產地") {
                    ...
                    Intent intent = new Intent();
                    intent.setClass(TypeActivity.this,TypeActivity.class);
                    startActivity(intent);
                }
    ...
    private Button.OnClickListener btn_c2mListner =
            new Button.OnClickListener() {
                public void onClick(View v) {
                    ...
                    m_intent.setClass(TypeActivity.this,MainActivity.class);
    ...
    private Button.OnClickListener btn_c2lListner =
            new Button.OnClickListener() {
                public void onClick(View v) {
                    Intent intent = new Intent();
                    intent.setClass(TypeActivity.this,LibraryHome.class);
                    startActivity(intent);
                }
            };
